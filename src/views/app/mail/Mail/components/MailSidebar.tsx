                ...
                <Menu className="mx-2 mb-10">
                    {groupList.map((menu) => {
                        if (
                            ...
                            return null // Skip rendering for SuperAdmin and 'inbox' value
                        }else if(user?.role === RoleEnum.MahalluAdmin && menu.value === 'sent'){
                            return null // Skip rendering for MahalluAdmin and 'sent' value
                        }else if(user?.role === RoleEnum.InfoAdmin && menu.value === 'sent'){
                            return null // Skip rendering for InfoAdmin and 'sent' value
                        }
                        return (
                            <MenuItem
                                key={menu.value}
